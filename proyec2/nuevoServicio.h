...
namespace proyec2 {
	...
	/// <summary>
	/// Resumen de nuevoServicio
	/// </summary>
	public ref class nuevoServicio : public System::Windows::Forms::Form
	{
	public:
		String^ user;
		nuevoServicio(String^ user)
		{
			this->user = user;
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(797, 200);
			...
			this->Name = L"nuevoServicio";
			this->Text = L"nuevoServicio";
